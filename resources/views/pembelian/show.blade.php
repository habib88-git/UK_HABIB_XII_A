            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <p class="mb-0 fs-6">{{ \Carbon\Carbon::parse($pembelian->tanggal)->translatedFormat('d F Y H:i') }}</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="mb-3">
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <p class="mb-0 fs-6 fw-bold text-success">Rp {{ number_format($pembelian->total_harga, 0, ',', '.') }}</p>
                    </div>
                </div>
            </div>
        </div>
