                                            ...
                                            <tbody>
                                                @foreach ($pembelian->details as $index => $detail)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control kategori-display"
            ...
            document.addEventListener('change', function(e) {
                if (e.target.classList.contains('produk-select')) {
                    ...
                    if (selectedOption.value) {
                        // Set kategori
                        row.querySelector('.kategori-display').value = selectedOption.getAttribute(
                            'data-kategori') || '';
                        // Set satuan
                        row.querySelector('.satuan-display').value = selectedOption.getAttribute(
                            'data-satuan') || '';
