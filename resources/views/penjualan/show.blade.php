        ...
        <div class="card-body">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-6">
                    ...
                    <p><strong>Total Harga:</strong> <span class="text-success">Rp {{ number_format($penjualan->total_harga, 0, ',', '.') }}</span></p>
                </div>
            </div>
                    ...
                    <tfoot>
                        ...
                        <tr>
                            <td colspan="2" class="text-end">
                                <strong>Diskon ({{ floor($penjualan->total_harga / 100000) * 5 }}%):</strong>
                            </td>
                        ...
                        <tr class="table-success">
                            ...
                            <td class="text-end">
                                <strong>Rp {{ number_format($penjualan->total_harga - $penjualan->diskon, 0, ',', '.') }}</strong>
                            </td>
                        </tr>
                    </tfoot>
                </table>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    <div class="card bg-light border-0 shadow-sm p-3">
                        ...
                        <p class="mb-0 text-success">Rp {{ number_format($penjualan->pembayaran->jumlah ?? 0, 0, ',', '.') }}</p>
                    </div>
                </div>
                <div class="col-md-4 mb-3">
                    <div class="card bg-light border-0 shadow-sm p-3">
                        <strong>Kembalian:</strong>
                        <p class="mb-0 text-danger">Rp {{ number_format($penjualan->pembayaran->kembalian ?? 0, 0, ',', '.') }}</p>
                    </div>
                </div>
            </div>
