    ...
    <div class="card shadow-sm mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">
                <i class="fas fa-pen me-1"></i> Form Edit Supplier
            </h6>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" id="nama_supplier" name="nama_supplier" class="form-control"
                               value="{{ old('nama_supplier', $supplier->nama_supplier) }}" placeholder="Masukkan nama supplier" required maxlength="100">
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" id="no_telp" name="no_telp" class="form-control"
                               value="{{ old('no_telp', $supplier->no_telp) }}" placeholder="Masukkan nomor telepon" required maxlength="15" pattern="[0-9]+"
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea id="alamat" name="alamat" class="form-control" rows="3" placeholder="Masukkan alamat lengkap" required>{{ old('alamat', $supplier->alamat) }}</textarea>
                    </div>
                </div>
